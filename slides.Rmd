---
title: "Coding in the Open<br>"
subtitle: "Developing Reproducible Analytical Pipelines Using Open Source Software"
author: 'David Caldwell <br> Principal Information Analyst <br> Public health Scotland'
date: "15 June 2021 <br><br> 
Slides: https://github.com/davidc92/edinbr-2021"
output:
...
- Public Health Scotland (PHS) of the National Health Service (NHS) Scotland produces around 200 official and national statistics publications each year.
...
https://github.com/Public-Health-Scotland/hsmr-new
...
First released: 13th August 2019 <br>
...
- The [Transforming Publishing (TPP)](https://www.isdscotland.org/Products-and-Services/Transforming-Publishing-Programme/) team have begun to roll out RAP to other teams in PHS using a buddy system
...
```{r out.width = "90%", fig.align = 'center'}
include_graphics(here::here("images", "progress.png"))
```
...
[Email](mailto:david.caldwell@phs.scot)
[GitHub](https://github.com/davidc92)

### Transforming Publishing

[Email](mailto:phs.transformingpublishing@phs.scot)
[GitHub](https://github.com/Public-Health-Scotland)